		...
		opts = {
			...
			prompt_library = {
				...
				["React Frontend Specialist"] = {
					strategy = "chat",
					description = "Professional React and JavaScript frontend specialist for code review, debugging, and best practices.",
					prompts = {
						{
							role = "system",
							content = "You are a senior frontend developer specializing in React and modern JavaScript. You write clean, efficient, and accessible code, follow best practices, and provide clear, actionable feedback.",
						},
						{
							role = "user",
