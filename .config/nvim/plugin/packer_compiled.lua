...
_G.packer_plugins = {
  ...
  ["SchemaStore.nvim"] = {
    loaded = true,
    path = "/home/mf/.local/share/nvim/site/pack/packer/start/SchemaStore.nvim",
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/mf/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["nvim-gps"] = {
    loaded = true,
    path = "/home/mf/.local/share/nvim/site/pack/packer/start/nvim-gps",
